...
proc adi_ip_constraints {ip_name ip_constr_files} {
  ...
  set proj_filegroup [ipx::get_file_groups xilinx_verilogsynthesis [lindex [ipx::current_core] 1]
  ipx::add_file $ip_constr_files $proj_filegroup
  set_property type {{xdc}} [ipx::get_files $ip_constr_files $proj_filegroup]
  set_property library_name {} [ipx::get_files $ip_constr_files $proj_filegroup]
}
...
proc adi_ip_properties {ip_name} {
  ...
  set_property slave_memory_map_ref {s_axi} [ipx::get_bus_interfaces s_axi [ipx::current_core]]

  ipx::add_address_block {axi_lite} [ipx::get_memory_maps s_axi [ipx::current_core]]
  set_property range {65536} [ipx::get_address_blocks axi_lite \
    [ipx::get_memory_maps s_axi [ipx::current_core]]]
...
proc adi_set_bus_dependency {bus prefix dependency} {
	set_property ENABLEMENT_DEPENDENCY $dependency [ipx::get_bus_interfaces $bus [lindex[ipx::current_core] 1]
