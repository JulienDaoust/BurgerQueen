...
if {![info exists REQUIRED_VIVADO_VERSION]} {
  set REQUIRED_VIVADO_VERSION "2015.2" ;# was 2014.2 JC
}

#if {[info exists ::env(ADI_IGNORE_VERSION_CHECK)]} {  JC: don't check this...
...
proc adi_project_run {project_name} {
  ...
  # JC: marche pas (probleme specifique a 2015.2 ???) - mieux de le faire a la main...
