...
int configGPIOs () {
  ...
  GPIO_MIOConfigPtr = XGpioPs_LookupConfig(XPAR_PS7_GPIO_0_DEVICE_ID );//;XPAR_XGPIOPS_0_DEVICE_ID
  ...
  XGpio_SetDataDirection ( &GpioAXI, 1, 0xFFFF);
  XGpio_SetDataDirection ( &GpioAXI,2,0x0000 );
...
void setTimerAndIntr() {
  ...
  XScuGic_Connect(&InterruptController, XPAR_PS7_SCUTIMER_0_DEVICE_ID, TimerIntrHandler,&Timer ) ;

  /* enable the interrupt for the Timer at GIC */
  XScuGic_Enable(&InterruptController, XPAR_PS7_SCUTIMER_0_DEVICE_ID) ;
