...
################################################################
# This is a generated script based on design: BD_tp1
#
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.PCW_SD0_PERIPHERAL_ENABLE {1} CONFIG.PCW_TTC0_PERIPHERAL_ENABLE {1} CONFIG.PCW_TTC1_PERIPHERAL_ENABLE {0} CONFIG.PCW_UART1_PERIPHERAL_ENABLE {1} CONFIG.preset {ZedBoard}  ] $processing_system7_0
